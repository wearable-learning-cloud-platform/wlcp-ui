sap.ui.controller("org.wlcp.wlcp-ui.controller.MainToolpage", {
	...
	handleAvatarPress : function(oEvent) {
		...
		//Create and popover
		if (! this._oPopover) {
			this._oPopover = sap.ui.xmlfragment("org.wlcp.wlcp-ui.fragment.UsernamePopover", this);
...
*/
	onInit: function() {
		...
		this.model.loadData("model/Dashboard.json");
